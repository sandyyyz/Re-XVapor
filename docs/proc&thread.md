...
![thread_info](image/image-35.png)

## state

![state_machine](image/image-36.png)
...
![thstate_machine](image/image-38.png)  
...
![procstate_machine](image/image-39.png)
...
![exit](image/image-41.png)

## wait 

![wait](image/image-43.png)

## 关于线程切换
swtch(&save_des, &des_context)存储callee-saved regs, 然后切换到目标的context：

![swtch](image/image-42.png)
...
![parent_sleep](image/image-45.png)
3. 子进程在wakeup父进程之前，必须先获取父进程锁
![child_wakeup](image/image-46.png)


## xv6 原有的地址分配
![xv6_memlayout](image/image-48.png)
![xv6_memlayout2](image/image-49.png)
